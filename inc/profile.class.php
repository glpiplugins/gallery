...
/**
 * Class PluginGalleryProfile
 */
class PluginGalleryProfile extends Profile {
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate = 0) {
      ...
      if ($item->getType() == 'Profile' && $item->getField('interface') != 'helpdesk') {
         return _n('Gallery', 'Galleries', 2, 'gallery');
      }
      return '';
   }
   ...
   static function displayTabContentForItem(CommonGLPI $item, $tabnum = 1, $withtemplate = 0) {
      ...
      if ($item->getType() == 'Profile') {
         ...
         self::addDefaultProfileInfos($ID, ['plugin_gallery' => 0]);
         $prof->showForm($ID);
      }
      return true;
   }
   ...
   static function createFirstAccess($ID) {
      //85
      self::addDefaultProfileInfos($ID, ['plugin_gallery' => ALLSTANDARDRIGHT], true);
   }
   ...
   static function getAllRights($all = false) {
      $rights = [
         ['itemtype' => 'PluginGalleryGallery',
               'label'    => PluginGalleryGallery::getTypeName(2),
               'field'    => 'plugin_gallery'
         ],
      ];
